...
# Date: 01/25/2021
# Description: Lab 3 part 1 - southern state list
########################################################
...
print("UNSORTED:\n")
print(southern_states[0].title())
print(southern_states[1].title())
print(southern_states[2].title())
print(southern_states[3].title())
print(southern_states[4].title())
print(southern_states[5].title())
print(southern_states[6].title())
print(southern_states[7].title())
print(southern_states[8].title())
print(southern_states[9].title())
print(southern_states[10].title())
...
# use neg index to access last element in list and show it in title case
print(f"\nLast state in this ordered list: {southern_states[-1].title()}.\n")
